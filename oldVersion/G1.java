...
class G1 {
    ...
    private void start() {
        System.out.println("도움말이 필요하시면 \"help\" 를 입력하시오.");
        ...
        if (correct == -1) {
            ...
            System.out.println("입력값이 잘못 되었습니다. 다시 입력해 주십시오.");
            start();
        } else {
            while (!G_OVER) {
    ...
    private void printHelp() {
        System.out.println("난이도 선택시 'H', 'M', 'E'를 입력하고\n" +
           " 엔터를 치시면 시작됩니다. \n 좌표값 입력시" +
           " [명령어] [x좌표] [y좌표]로 값을 넣어줍니다.\n" +
           " 명령어에는 'P', 'F' 가 있으며 'P'는 선택하기 'F'는 깃발 세우기 입니다.\n" +
           " 예시 명령어: P 5 5");
    }
    ...
    private void selectEasy() {
        System.out.println("쉬움을 선택하셨습니다.");
        System.out.println("지뢰 갯수:" + E_MINE_NUM);
